...
class Main{
	public static void main(String[]args){
		...
		int shootbyharry = s.nextInt();
		int shootbylarry = s.nextInt();
		int notshootbyharry = shootbyharry -10;
		int notshootbylarry = shootbylarry - 10;
		System.out.print(Math.abs(notshootbyharry)+" "+ Math.abs(notshootbylarry));
	}
}